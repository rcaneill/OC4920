...
def corr_coef(datadir,SK_filename,TB_filename):
    ...
    plt.savefig('Figures/Calib/temp_20181210.png')
    plt.savefig('Figures/Calib/temp_20181210.pdf')
    plt.close()
    ...
    plt.savefig('Figures/Calib/sal_20181210.png')
    plt.savefig('Figures/Calib/sal_20181210.pdf')
    plt.close()
